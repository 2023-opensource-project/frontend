...
import { Section, StepSection, StepObj, IconWrap, TextStyle } from "./MainFirstSection.style";
...
function MainFirstSection() {
  return (
    <Section>
      ...
      <TextStyle fontSize="18px" margin="0 0 40px 0 ">
      ...
      <StepSection>
        <StepObj>
          ...
          <TextStyle fontSize="24px" fontWeight="500" margin="0 0 10px 0 ">
            STEP 01
          </TextStyle>
          <TextStyle fontSize="14px" fontWeight="300">
            마스터 이력서를
            <br />
            작성해 보세요.
          </TextStyle>
